...
if (n->sym == sym_translation_unit)
  return ((n->child[0] && n->child[0]->sym == sym_external_declaration) ||
          (n->child[0] && n->child[0]->sym == sym_translation_unit &&
           n->child[1] && n->child[1]->sym == sym_external_declaration) ||
          (n->child[0] && n->child[0]->sym == sym_translation_unit &&
...
if (n->sym == sym_primary_expression)
  return ((n->child[0] && n->child[0]->sym == sym_IDENTIFIER) ||
          (n->child[0] && n->child[0]->sym == sym_constant) ||
          (n->child[0] && n->child[0]->sym == sym_string) ||
          (n->child[0] && n->child[0]->sym == token_symbol('(') &&
           n->child[1] && n->child[1]->sym == sym_expression_error &&
           n->child[2] && n->child[2]->sym == token_symbol(')')) ||
          (n->child[0] && n->child[0]->sym == sym_generic_selection));
if (n->sym == sym_expression_error)
  return ((n->child[0] && n->child[0]->sym == sym_expression) ||
          (n->child[0] && n->child[0]->sym == sym_error));
if (n->sym == sym_constant)
  return ((n->child[0] && n->child[0]->sym == sym_I_CONSTANT) ||
          (n->child[0] && n->child[0]->sym == sym_F_CONSTANT) ||
          (n->child[0] && n->child[0]->sym == sym_ENUMERATION_CONSTANT));
if (n->sym == sym_enumeration_constant)
  return ((n->child[0] && n->child[0]->sym == sym_IDENTIFIER));
if (n->sym == sym_string)
  return ((n->child[0] && n->child[0]->sym == sym_STRING_LITERAL) ||
          (n->child[0] && n->child[0]->sym == sym_FUNC_NAME));
...
if (n->sym == sym_generic_assoc_list)
  return ((n->child[0] && n->child[0]->sym == sym_generic_association) ||
          (n->child[0] && n->child[0]->sym == sym_generic_assoc_list &&
           n->child[1] && n->child[1]->sym == token_symbol(',') &&
           n->child[2] && n->child[2]->sym == sym_generic_association));
...
if (n->sym == sym_postfix_expression)
  return ((n->child[0] && n->child[0]->sym == sym_primary_expression) ||
          (n->child[0] && n->child[0]->sym == sym_function_call) ||
          (n->child[0] && n->child[0]->sym == sym_array_access) ||
          (n->child[0] && n->child[0]->sym == sym_postfix_expression &&
           n->child[1] && n->child[1]->sym == token_symbol('.') &&
           n->child[2] && n->child[2]->sym == sym_member_identifier) ||
          (n->child[0] && n->child[0]->sym == sym_postfix_expression &&
           n->child[1] && n->child[1]->sym == sym_PTR_OP &&
           n->child[2] && n->child[2]->sym == sym_member_identifier) ||
          (n->child[0] && n->child[0]->sym == sym_postfix_expression &&
           n->child[1] && n->child[1]->sym == sym_INC_OP) ||
          (n->child[0] && n->child[0]->sym == sym_postfix_expression &&
           n->child[1] && n->child[1]->sym == sym_DEC_OP) ||
          (n->child[0] && n->child[0]->sym == token_symbol('(') &&
           n->child[1] && n->child[1]->sym == sym_type_name &&
           n->child[2] && n->child[2]->sym == token_symbol(')') &&
           n->child[3] && n->child[3]->sym == sym_postfix_initializer));
...
if (n->sym == sym_cast_expression)
  return ((n->child[0] && n->child[0]->sym == sym_unary_expression) ||
          (n->child[0] && n->child[0]->sym == token_symbol('(') &&
           n->child[1] && n->child[1]->sym == sym_type_name &&
           n->child[2] && n->child[2]->sym == token_symbol(')') &&
           n->child[3] && n->child[3]->sym == sym_cast_expression));
if (n->sym == sym_multiplicative_expression)
  return ((n->child[0] && n->child[0]->sym == sym_cast_expression) ||
          (n->child[0] && n->child[0]->sym == sym_multiplicative_expression &&
           n->child[1] && n->child[1]->sym == token_symbol('*') &&
           n->child[2] && n->child[2]->sym == sym_cast_expression) ||
          (n->child[0] && n->child[0]->sym == sym_multiplicative_expression &&
           n->child[1] && n->child[1]->sym == token_symbol('/') &&
           n->child[2] && n->child[2]->sym == sym_cast_expression) ||
          (n->child[0] && n->child[0]->sym == sym_multiplicative_expression &&
...
if (n->sym == sym_additive_expression)
  return ((n->child[0] && n->child[0]->sym == sym_multiplicative_expression) ||
          (n->child[0] && n->child[0]->sym == sym_additive_expression &&
           n->child[1] && n->child[1]->sym == token_symbol('+') &&
           n->child[2] && n->child[2]->sym == sym_multiplicative_expression) ||
          (n->child[0] && n->child[0]->sym == sym_additive_expression &&
           n->child[1] && n->child[1]->sym == token_symbol('-') &&
           n->child[2] && n->child[2]->sym == sym_multiplicative_expression));
if (n->sym == sym_shift_expression)
  return ((n->child[0] && n->child[0]->sym == sym_additive_expression) ||
          (n->child[0] && n->child[0]->sym == sym_shift_expression &&
           n->child[1] && n->child[1]->sym == sym_LEFT_OP &&
           n->child[2] && n->child[2]->sym == sym_additive_expression) ||
          (n->child[0] && n->child[0]->sym == sym_shift_expression &&
           n->child[1] && n->child[1]->sym == sym_RIGHT_OP &&
           n->child[2] && n->child[2]->sym == sym_additive_expression));
if (n->sym == sym_relational_expression)
  return ((n->child[0] && n->child[0]->sym == sym_shift_expression) ||
          (n->child[0] && n->child[0]->sym == sym_relational_expression &&
           n->child[1] && n->child[1]->sym == token_symbol('<') &&
           n->child[2] && n->child[2]->sym == sym_shift_expression) ||
          (n->child[0] && n->child[0]->sym == sym_relational_expression &&
           n->child[1] && n->child[1]->sym == token_symbol('>') &&
           n->child[2] && n->child[2]->sym == sym_shift_expression) ||
          (n->child[0] && n->child[0]->sym == sym_relational_expression &&
...
if (n->sym == sym_equality_expression)
  return ((n->child[0] && n->child[0]->sym == sym_relational_expression) ||
          (n->child[0] && n->child[0]->sym == sym_equality_expression &&
           n->child[1] && n->child[1]->sym == sym_EQ_OP &&
           n->child[2] && n->child[2]->sym == sym_relational_expression) ||
          (n->child[0] && n->child[0]->sym == sym_equality_expression &&
           n->child[1] && n->child[1]->sym == sym_NE_OP &&
           n->child[2] && n->child[2]->sym == sym_relational_expression));
if (n->sym == sym_and_expression)
  return ((n->child[0] && n->child[0]->sym == sym_equality_expression) ||
          (n->child[0] && n->child[0]->sym == sym_and_expression &&
           n->child[1] && n->child[1]->sym == token_symbol('&') &&
           n->child[2] && n->child[2]->sym == sym_equality_expression));
if (n->sym == sym_exclusive_or_expression)
  return ((n->child[0] && n->child[0]->sym == sym_and_expression) ||
          (n->child[0] && n->child[0]->sym == sym_exclusive_or_expression &&
           n->child[1] && n->child[1]->sym == token_symbol('^') &&
           n->child[2] && n->child[2]->sym == sym_and_expression));
if (n->sym == sym_inclusive_or_expression)
  return ((n->child[0] && n->child[0]->sym == sym_exclusive_or_expression) ||
          (n->child[0] && n->child[0]->sym == sym_inclusive_or_expression &&
           n->child[1] && n->child[1]->sym == token_symbol('|') &&
           n->child[2] && n->child[2]->sym == sym_exclusive_or_expression));
if (n->sym == sym_logical_and_expression)
  return ((n->child[0] && n->child[0]->sym == sym_inclusive_or_expression) ||
          (n->child[0] && n->child[0]->sym == sym_logical_and_expression &&
           n->child[1] && n->child[1]->sym == sym_AND_OP &&
           n->child[2] && n->child[2]->sym == sym_inclusive_or_expression));
if (n->sym == sym_logical_or_expression)
  return ((n->child[0] && n->child[0]->sym == sym_logical_and_expression) ||
          (n->child[0] && n->child[0]->sym == sym_logical_or_expression &&
           n->child[1] && n->child[1]->sym == sym_OR_OP &&
           n->child[2] && n->child[2]->sym == sym_logical_and_expression));
if (n->sym == sym_conditional_expression)
  return ((n->child[0] && n->child[0]->sym == sym_logical_or_expression) ||
          (n->child[0] && n->child[0]->sym == sym_logical_or_expression &&
           n->child[1] && n->child[1]->sym == token_symbol('?') &&
           n->child[2] && n->child[2]->sym == sym_expression &&
           n->child[3] && n->child[3]->sym == token_symbol(':') &&
           n->child[4] && n->child[4]->sym == sym_conditional_expression));
if (n->sym == sym_assignment_expression)
  return ((n->child[0] && n->child[0]->sym == sym_conditional_expression) ||
          (n->child[0] && n->child[0]->sym == sym_unary_expression &&
           n->child[1] && n->child[1]->sym == sym_assignment_operator &&
           n->child[2] && n->child[2]->sym == sym_assignment_expression) ||
          (n->child[0] && n->child[0]->sym == sym_unary_expression &&
           n->child[1] && n->child[1]->sym == sym_assignment_operator &&
           n->child[2] && n->child[2]->sym == sym_postfix_initializer) ||
...
if (n->sym == sym_assignment_operator)
  return ((n->child[0] && n->child[0]->sym == token_symbol('=')) ||
          (n->child[0] && n->child[0]->sym == sym_MUL_ASSIGN) ||
          (n->child[0] && n->child[0]->sym == sym_DIV_ASSIGN) ||
          (n->child[0] && n->child[0]->sym == sym_MOD_ASSIGN) ||
          (n->child[0] && n->child[0]->sym == sym_ADD_ASSIGN) ||
          (n->child[0] && n->child[0]->sym == sym_SUB_ASSIGN) ||
          (n->child[0] && n->child[0]->sym == sym_LEFT_ASSIGN) ||
          (n->child[0] && n->child[0]->sym == sym_RIGHT_ASSIGN) ||
          (n->child[0] && n->child[0]->sym == sym_AND_ASSIGN) ||
          (n->child[0] && n->child[0]->sym == sym_XOR_ASSIGN) ||
          (n->child[0] && n->child[0]->sym == sym_OR_ASSIGN));
...
if (n->sym == sym_declaration)
  return ((n->child[0] && n->child[0]->sym == sym_declaration_specifiers &&
          ...
          (n->child[0] && n->child[0]->sym == sym_declaration_specifiers &&
           ...
           n->child[2] && n->child[2]->sym == token_symbol(';')) ||
          (n->child[0] && n->child[0]->sym == sym_static_assert_declaration));
if (n->sym == sym_declaration_specifiers)
  return ((n->child[0] && n->child[0]->sym == sym_storage_class_specifier &&
           n->child[1] && n->child[1]->sym == sym_declaration_specifiers) ||
          (n->child[0] && n->child[0]->sym == sym_storage_class_specifier) ||
...
if (n->sym == sym_init_declarator_list)
  return ((n->child[0] && n->child[0]->sym == sym_init_declarator) ||
          (n->child[0] && n->child[0]->sym == sym_init_declarator_list &&
           n->child[1] && n->child[1]->sym == token_symbol(',') &&
           n->child[2] && n->child[2]->sym == sym_init_declarator));
if (n->sym == sym_init_declarator)
  return ((n->child[0] && n->child[0]->sym == sym_declarator &&
           n->child[1] && n->child[1]->sym == token_symbol('=') &&
           n->child[2] && n->child[2]->sym == sym_initializer) ||
          (n->child[0] && n->child[0]->sym == sym_declarator));
if (n->sym == sym_storage_class_specifier)
  return ((n->child[0] && n->child[0]->sym == sym_TYPEDEF) ||
          (n->child[0] && n->child[0]->sym == sym_EXTERN) ||
          (n->child[0] && n->child[0]->sym == sym_STATIC) ||
          (n->child[0] && n->child[0]->sym == sym_THREAD_LOCAL) ||
          (n->child[0] && n->child[0]->sym == sym_AUTO) ||
          (n->child[0] && n->child[0]->sym == sym_REGISTER) ||
          (n->child[0] && n->child[0]->sym == sym_TRACE));
if (n->sym == sym_type_specifier)
  return ((n->child[0] && n->child[0]->sym == sym_types));
if (n->sym == sym_types)
  return ((n->child[0] && n->child[0]->sym == sym_VOID) ||
          (n->child[0] && n->child[0]->sym == sym_CHAR) ||
          (n->child[0] && n->child[0]->sym == sym_SHORT) ||
          (n->child[0] && n->child[0]->sym == sym_INT) ||
          (n->child[0] && n->child[0]->sym == sym_LONG) ||
          (n->child[0] && n->child[0]->sym == sym_FLOAT) ||
          (n->child[0] && n->child[0]->sym == sym_DOUBLE) ||
          (n->child[0] && n->child[0]->sym == sym_SIGNED) ||
          (n->child[0] && n->child[0]->sym == sym_UNSIGNED) ||
          (n->child[0] && n->child[0]->sym == sym_BOOL) ||
          (n->child[0] && n->child[0]->sym == sym_COMPLEX) ||
          (n->child[0] && n->child[0]->sym == sym_IMAGINARY) ||
          (n->child[0] && n->child[0]->sym == sym_atomic_type_specifier) ||
          (n->child[0] && n->child[0]->sym == sym_struct_or_union_specifier) ||
          (n->child[0] && n->child[0]->sym == sym_enum_specifier) ||
          (n->child[0] && n->child[0]->sym == sym_TYPEDEF_NAME));
...
if (n->sym == sym_struct_or_union)
  return ((n->child[0] && n->child[0]->sym == sym_STRUCT) ||
          (n->child[0] && n->child[0]->sym == sym_UNION));
if (n->sym == sym_struct_declaration_list)
  return ((n->child[0] && n->child[0]->sym == sym_struct_declaration) ||
          (n->child[0] && n->child[0]->sym == sym_struct_declaration_list &&
           n->child[1] && n->child[1]->sym == sym_struct_declaration));
...
if (n->sym == sym_specifier_qualifier_list)
  return ((n->child[0] && n->child[0]->sym == sym_type_specifier &&
           n->child[1] && n->child[1]->sym == sym_specifier_qualifier_list) ||
          (n->child[0] && n->child[0]->sym == sym_type_specifier) ||
          (n->child[0] && n->child[0]->sym == sym_type_qualifier &&
           n->child[1] && n->child[1]->sym == sym_specifier_qualifier_list) ||
          (n->child[0] && n->child[0]->sym == sym_type_qualifier));
if (n->sym == sym_struct_declarator_list)
  return ((n->child[0] && n->child[0]->sym == sym_struct_declarator) ||
          (n->child[0] && n->child[0]->sym == sym_struct_declarator_list &&
           n->child[1] && n->child[1]->sym == token_symbol(',') &&
           n->child[2] && n->child[2]->sym == sym_struct_declarator));
...
if (n->sym == sym_enumerator_list)
  return ((n->child[0] && n->child[0]->sym == sym_enumerator) ||
          (n->child[0] && n->child[0]->sym == sym_enumerator_list &&
           n->child[1] && n->child[1]->sym == token_symbol(',') &&
           n->child[2] && n->child[2]->sym == sym_enumerator));
...
if (n->sym == sym_type_qualifier)
  return ((n->child[0] && n->child[0]->sym == sym_CONST) ||
          (n->child[0] && n->child[0]->sym == sym_RESTRICT) ||
          (n->child[0] && n->child[0]->sym == sym_VOLATILE) ||
          (n->child[0] && n->child[0]->sym == sym_ATOMIC) ||
          (n->child[0] && n->child[0]->sym == sym_MAYBECONST));
if (n->sym == sym_function_specifier)
  return ((n->child[0] && n->child[0]->sym == sym_INLINE) ||
          (n->child[0] && n->child[0]->sym == sym_NORETURN));
...
if (n->sym == sym_declarator)
  return ((n->child[0] && n->child[0]->sym == sym_pointer &&
           n->child[1] && n->child[1]->sym == sym_direct_declarator) ||
...
if (n->sym == sym_pointer)
  return ((n->child[0] && n->child[0]->sym == token_symbol('*') &&
           ...
           n->child[2] && n->child[2]->sym == sym_pointer) ||
          (n->child[0] && n->child[0]->sym == token_symbol('*') &&
           n->child[1] && n->child[1]->sym == sym_type_qualifier_list) ||
          (n->child[0] && n->child[0]->sym == token_symbol('*') &&
           n->child[1] && n->child[1]->sym == sym_pointer) ||
          (n->child[0] && n->child[0]->sym == token_symbol('*')));
if (n->sym == sym_type_qualifier_list)
  return ((n->child[0] && n->child[0]->sym == sym_type_qualifier) ||
          (n->child[0] && n->child[0]->sym == sym_type_qualifier_list &&
           n->child[1] && n->child[1]->sym == sym_type_qualifier));
if (n->sym == sym_parameter_type_list)
  return ((n->child[0] && n->child[0]->sym == sym_parameter_list &&
           n->child[1] && n->child[1]->sym == token_symbol(',') &&
           n->child[2] && n->child[2]->sym == sym_ELLIPSIS) ||
          (n->child[0] && n->child[0]->sym == sym_parameter_list));
if (n->sym == sym_parameter_list)
  return ((n->child[0] && n->child[0]->sym == sym_parameter_declaration) ||
          (n->child[0] && n->child[0]->sym == sym_parameter_list &&
           n->child[1] && n->child[1]->sym == token_symbol(',') &&
           n->child[2] && n->child[2]->sym == sym_parameter_declaration));
...
if (n->sym == sym_identifier_list)
  return ((n->child[0] && n->child[0]->sym == sym_IDENTIFIER) ||
          (n->child[0] && n->child[0]->sym == sym_identifier_list &&
           n->child[1] && n->child[1]->sym == token_symbol(',') &&
           n->child[2] && n->child[2]->sym == sym_IDENTIFIER));
...
if (n->sym == sym_abstract_declarator)
  return ((n->child[0] && n->child[0]->sym == sym_pointer &&
           n->child[1] && n->child[1]->sym == sym_direct_abstract_declarator) ||
          (n->child[0] && n->child[0]->sym == sym_pointer) ||
...
if (n->sym == sym_initializer)
  return ((n->child[0] && n->child[0]->sym == token_symbol('{') &&
          ...
          (n->child[0] && n->child[0]->sym == token_symbol('{') &&
           ...
           n->child[2] && n->child[2]->sym == token_symbol(',') &&
           n->child[3] && n->child[3]->sym == token_symbol('}')) ||
          (n->child[0] && n->child[0]->sym == sym_assignment_expression));
if (n->sym == sym_initializer_list)
  return ((n->child[0] && n->child[0]->sym == sym_designation &&
           n->child[1] && n->child[1]->sym == sym_initializer) ||
          (n->child[0] && n->child[0]->sym == sym_initializer) ||
          (n->child[0] && n->child[0]->sym == sym_initializer_list &&
           n->child[1] && n->child[1]->sym == token_symbol(',') &&
           n->child[2] && n->child[2]->sym == sym_designation &&
           n->child[3] && n->child[3]->sym == sym_initializer) ||
          (n->child[0] && n->child[0]->sym == sym_initializer_list &&
           n->child[1] && n->child[1]->sym == token_symbol(',') &&
           n->child[2] && n->child[2]->sym == sym_initializer));
...
if (n->sym == sym_designator_list)
  return ((n->child[0] && n->child[0]->sym == sym_designator) ||
          (n->child[0] && n->child[0]->sym == sym_designator_list &&
           n->child[1] && n->child[1]->sym == sym_designator));
...
if (n->sym == sym_statement)
  return ((n->child[0] && n->child[0]->sym == sym_labeled_statement) ||
          (n->child[0] && n->child[0]->sym == sym_compound_statement) ||
          (n->child[0] && n->child[0]->sym == sym_expression_statement) ||
          (n->child[0] && n->child[0]->sym == sym_selection_statement) ||
          (n->child[0] && n->child[0]->sym == sym_iteration_statement) ||
          (n->child[0] && n->child[0]->sym == sym_jump_statement) ||
          (n->child[0] && n->child[0]->sym == sym_basilisk_statements) ||
          (n->child[0] && n->child[0]->sym == sym_error &&
           n->child[1] && n->child[1]->sym == token_symbol(';')));
if (n->sym == sym_labeled_statement)
  return ((n->child[0] && n->child[0]->sym == sym_generic_identifier &&
           n->child[1] && n->child[1]->sym == token_symbol(':') &&
           n->child[2] && n->child[2]->sym == sym_statement) ||
...
if (n->sym == sym_block_item_list)
  return ((n->child[0] && n->child[0]->sym == sym_block_item) ||
          (n->child[0] && n->child[0]->sym == sym_block_item_list &&
           n->child[1] && n->child[1]->sym == sym_block_item));
if (n->sym == sym_block_item)
  return ((n->child[0] && n->child[0]->sym == sym_declaration) ||
          (n->child[0] && n->child[0]->sym == sym_statement));
...
if (n->sym == sym_selection_statement)
  return ((n->child[0] && n->child[0]->sym == sym_IF &&
           ...
           n->child[6] && n->child[6]->sym == sym_statement) ||
...
if (n->sym == sym_for_scope)
  return ((n->child[0] && n->child[0]->sym == sym_FOR));
if (n->sym == sym_iteration_statement)
  return ((n->child[0] && n->child[0]->sym == sym_WHILE &&
          ...
          (n->child[0] && n->child[0]->sym == sym_for_scope &&
           ...
           n->child[4] && n->child[4]->sym == token_symbol(')') &&
           n->child[5] && n->child[5]->sym == sym_statement) ||
          (n->child[0] && n->child[0]->sym == sym_for_scope &&
           n->child[1] && n->child[1]->sym == token_symbol('(') &&
           n->child[2] && n->child[2]->sym == sym_expression_statement &&
           n->child[3] && n->child[3]->sym == sym_expression_statement &&
           ...
           n->child[5] && n->child[5]->sym == token_symbol(')') &&
           n->child[6] && n->child[6]->sym == sym_statement) ||
          (n->child[0] && n->child[0]->sym == sym_for_declaration_statement));
...
if (n->sym == sym_external_declaration)
  return ((n->child[0] && n->child[0]->sym == sym_function_definition) ||
          (n->child[0] && n->child[0]->sym == sym_declaration) ||
          (n->child[0] && n->child[0]->sym == sym_macro_statement) ||
          (n->child[0] && n->child[0]->sym == sym_event_definition) ||
          (n->child[0] && n->child[0]->sym == sym_boundary_definition) ||
          (n->child[0] && n->child[0]->sym == sym_external_foreach_dimension) ||
          (n->child[0] && n->child[0]->sym == sym_attribute) ||
          (n->child[0] && n->child[0]->sym == sym_error &&
           n->child[1] && n->child[1]->sym == sym_compound_statement));
...
if (n->sym == sym_function_definition)
  return ((n->child[0] && n->child[0]->sym == sym_function_declaration &&
           ...
           n->child[2] && n->child[2]->sym == sym_compound_statement) ||
...
if (n->sym == sym_declaration_list)
  return ((n->child[0] && n->child[0]->sym == sym_declaration) ||
          (n->child[0] && n->child[0]->sym == sym_declaration_list &&
           n->child[1] && n->child[1]->sym == sym_declaration));
if (n->sym == sym_basilisk_statements)
  return ((n->child[0] && n->child[0]->sym == sym_macro_statement) ||
          (n->child[0] && n->child[0]->sym == sym_foreach_statement) ||
          (n->child[0] && n->child[0]->sym == sym_foreach_inner_statement) ||
          (n->child[0] && n->child[0]->sym == sym_foreach_dimension_statement) ||
          (n->child[0] && n->child[0]->sym == sym_forin_declaration_statement) ||
          (n->child[0] && n->child[0]->sym == sym_forin_statement));
...
if (n->sym == sym_foreach_parameters)
  return ((n->child[0] && n->child[0]->sym == sym_foreach_parameter) ||
          (n->child[0] && n->child[0]->sym == sym_foreach_parameters &&
           n->child[1] && n->child[1]->sym == token_symbol(',') &&
           n->child[2] && n->child[2]->sym == sym_foreach_parameter));
...
if (n->sym == sym_reduction_list)
  return ((n->child[0] && n->child[0]->sym == sym_reduction) ||
          (n->child[0] && n->child[0]->sym == sym_reduction_list &&
           n->child[1] && n->child[1]->sym == sym_reduction));
...
if (n->sym == sym_reduction_operator)
  return ((n->child[0] && n->child[0]->sym == sym_generic_identifier) ||
          (n->child[0] && n->child[0]->sym == token_symbol('+')) ||
          (n->child[0] && n->child[0]->sym == sym_OR_OP));
...
if (n->sym == sym_forin_declaration_statement)
  return ((n->child[0] && n->child[0]->sym == sym_for_scope &&
           ...
           n->child[6] && n->child[6]->sym == token_symbol(')') &&
           n->child[7] && n->child[7]->sym == sym_statement));
...
if (n->sym == sym_event_parameters)
  return ((n->child[0] && n->child[0]->sym == sym_event_parameter) ||
          (n->child[0] && n->child[0]->sym == sym_event_parameters &&
           n->child[1] && n->child[1]->sym == token_symbol(',') &&
           n->child[2] && n->child[2]->sym == sym_event_parameter) ||
          (n->child[0] && n->child[0]->sym == sym_event_parameters &&
           n->child[1] && n->child[1]->sym == token_symbol(';') &&
           n->child[2] && n->child[2]->sym == sym_event_parameter));
if (n->sym == sym_event_parameter)
  return ((n->child[0] && n->child[0]->sym == sym_conditional_expression) ||
          (n->child[0] && n->child[0]->sym == sym_unary_expression &&
           n->child[1] && n->child[1]->sym == sym_assignment_operator &&
           n->child[2] && n->child[2]->sym == sym_conditional_expression) ||
          (n->child[0] && n->child[0]->sym == sym_unary_expression &&
           n->child[1] && n->child[1]->sym == sym_assignment_operator &&
           n->child[2] && n->child[2]->sym == sym_postfix_initializer));
...
if (n->sym == sym_external_foreach_dimension)
  return ((n->child[0] && n->child[0]->sym == sym_FOREACH_DIMENSION &&
           n->child[1] && n->child[1]->sym == token_symbol('(') &&
           n->child[2] && n->child[2]->sym == token_symbol(')') &&
           n->child[3] && n->child[3]->sym == sym_function_definition) ||
          (n->child[0] && n->child[0]->sym == sym_FOREACH_DIMENSION &&
           n->child[1] && n->child[1]->sym == token_symbol('(') &&
           n->child[2] && n->child[2]->sym == sym_I_CONSTANT &&
           n->child[3] && n->child[3]->sym == token_symbol(')') &&
           n->child[4] && n->child[4]->sym == sym_function_definition));
if (n->sym == sym_attribute)
  return ((n->child[0] && n->child[0]->sym == sym_generic_identifier &&
           ...
           n->child[3] && n->child[3]->sym == token_symbol('}')));
if (n->sym == sym_root)
  return ((n->child[0] && n->child[0]->sym == sym_translation_unit));
