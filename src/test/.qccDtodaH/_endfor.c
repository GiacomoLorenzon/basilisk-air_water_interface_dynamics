...
static int init_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0);*ip=i;*tp=t;return ret;}      static int init_0(const int i,const double t,Event *_ev){tracing("init_0","rising.c",104);
{
...
}{end_tracing("init_0","rising.c",115);return 0;}end_tracing("init_0","rising.c",115);}




static int acceleration_2_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++);*ip=i;*tp=t;return ret;}      static int acceleration_2(const int i,const double t,Event *_ev){tracing("acceleration_2","rising.c",120);
{
  vector av = a;
  foreach_face_stencil()_stencil_is_face_x(){
...
}{end_tracing("acceleration_2","rising.c",125);return 0;}end_tracing("acceleration_2","rising.c",125);}
# 174 "rising.c"
static int logfile_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++);*ip=i;*tp=t;return ret;}      static int logfile(const int i,const double t,Event *_ev){tracing("logfile","rising.c",174);
{
...
}{end_tracing("output_field_bolla","rising.c",250);return 0;}end_tracing("output_field_bolla","rising.c",250);}

static int output_field_fuori_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= 6.0001);*ip=i;*tp=t;return ret;}static int output_field_fuori_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t += 0.1);*ip=i;*tp=t;return ret;}static int output_field_fuori_expr2(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0.0);*ip=i;*tp=t;return ret;}      static int output_field_fuori(const int i,const double t,Event *_ev){tracing("output_field_fuori","rising.c",252);
{
...
static int interface_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= 6.0001);*ip=i;*tp=t;return ret;}static int interface_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t += 0.1);*ip=i;*tp=t;return ret;}static int interface_expr2(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0.0);*ip=i;*tp=t;return ret;}      static int interface(const int i,const double t,Event *_ev){tracing("interface","rising.c",306);
{
  ...
  fprintf(fp5, "\n=====================\n");
  fclose(fp5);
}{end_tracing("interface","rising.c",321);return 0;}end_tracing("interface","rising.c",321);}
# 338 "rising.c"
...
}{end_tracing("snapshot","rising.c",347);return 0;}end_tracing("snapshot","rising.c",347);}
# 417 "rising.c"
static int velocity_grid_x_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int velocity_grid_x(const int i,const double t,Event *_ev){tracing("velocity_grid_x","rising.c",417); {
  char name[80];
  ...
  fclose (fp);
}{end_tracing("velocity_grid_x","rising.c",432);return 0;}end_tracing("velocity_grid_x","rising.c",432);}
static int velocity_grid_y_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int velocity_grid_y(const int i,const double t,Event *_ev){tracing("velocity_grid_y","rising.c",433); {
  char name[80];
  ...
  fclose (fp);
}{end_tracing("velocity_grid_y","rising.c",448);return 0;}end_tracing("velocity_grid_y","rising.c",448);}
static int pressure_grid_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int pressure_grid(const int i,const double t,Event *_ev){tracing("pressure_grid","rising.c",449); {
  char name[80];
  ...
  fclose (fp);
}{end_tracing("pressure_grid","rising.c",464);return 0;}end_tracing("pressure_grid","rising.c",464);}
static int vorticity_grid_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int vorticity_grid(const int i,const double t,Event *_ev){tracing("vorticity_grid","rising.c",465); {
  char name[80];
...
}{end_tracing("vorticity_grid","rising.c",483);return 0;}end_tracing("vorticity_grid","rising.c",483);}
# 2 "ast/init_solver.h"
...
static void _init_solver (void)
{
  ...
  event_register((Event){0,1,init_0,{init_0_expr0},((int *)0),((double *)0),"rising.c",104,"init"});
  event_register((Event){0,1,logfile,{logfile_expr0},((int *)0),((double *)0),"rising.c",174,"logfile"});
  event_register((Event){0,3,output_field_bolla,{output_field_bolla_expr0,output_field_bolla_expr1,output_field_bolla_expr2},((int *)0),((double *)0),"rising.c",218,"output_field_bolla"});
  event_register((Event){0,3,output_field_fuori,{output_field_fuori_expr0,output_field_fuori_expr1,output_field_fuori_expr2},((int *)0),((double *)0),"rising.c",252,"output_field_fuori"});
  event_register((Event){0,3,interface,{interface_expr0,interface_expr1,interface_expr2},((int *)0),((double *)0),"rising.c",306,"interface"});
  event_register((Event){0,2,snapshot,{snapshot_expr0,snapshot_expr1},((int *)0),((double *)0),"rising.c",338,"snapshot"});
  event_register((Event){0,1,velocity_grid_x,{velocity_grid_x_expr0},((int *)0),((double *)0),"rising.c",417,"velocity_grid_x"});
  event_register((Event){0,1,velocity_grid_y,{velocity_grid_y_expr0},((int *)0),((double *)0),"rising.c",433,"velocity_grid_y"});
  event_register((Event){0,1,pressure_grid,{pressure_grid_expr0},((int *)0),((double *)0),"rising.c",449,"pressure_grid"});
  event_register((Event){0,1,vorticity_grid,{vorticity_grid_expr0},((int *)0),((double *)0),"rising.c",465,"vorticity_grid"});
  ...
  event_register((Event){0,1,acceleration_2,{acceleration_2_expr0},((int *)0),((double *)0),"rising.c",120,"acceleration"});
