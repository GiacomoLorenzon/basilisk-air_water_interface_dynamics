...
static int init_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0);*ip=i;*tp=t;return ret;}      static int init_0(const int i,const double t,Event *_ev){tracing("init_0","rising.c",81);
{
...
}{end_tracing("init_0","rising.c",92);return 0;}end_tracing("init_0","rising.c",92);}




static int acceleration_2_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++);*ip=i;*tp=t;return ret;}      static int acceleration_2(const int i,const double t,Event *_ev){tracing("acceleration_2","rising.c",97);
{
  vector av = a;
  foreach_face_stencil()_stencil_is_face_x(){
...
}{end_tracing("acceleration_2","rising.c",102);return 0;}end_tracing("acceleration_2","rising.c",102);}
#line 122 "rising.c"
static int output_field_bolla_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 3.0);*ip=i;*tp=t;return ret;}      static int output_field_bolla(const int i,const double t,Event *_ev){tracing("output_field_bolla","rising.c",122);
{

    char nameF[80];
    sprintf (nameF, "rising_output_7_2/output_field_bolla-%2.1f.txt", t);
...
}{end_tracing("output_field_bolla","rising.c",154);return 0;}end_tracing("output_field_bolla","rising.c",154);}

static int vprofile_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.7);*ip=i;*tp=t;return ret;}      static int vprofile(const int i,const double t,Event *_ev){tracing("vprofile","rising.c",156); {
  char name[80];

 sprintf (name, "8sec-%g", t);
  FILE*fp = fopen (name, "w");
    for (double y = 0; y <= 0.5; y += 0.02)
    {
        for (double x = 0; x <= 2; x += 0.02)
        {
            fprintf (fp, " %g %g", interpolate ((struct _interpolate){u.x, x, y})*interpolate ((struct _interpolate){f, x, y}), interpolate ((struct _interpolate){u.y, x, y})*interpolate ((struct _interpolate){f, x, y}));
        }
        fprintf (fp, " \n");
    }
  fclose (fp);
}{end_tracing("vprofile","rising.c",170);return 0;}end_tracing("vprofile","rising.c",170);}

static int vprofilebolla_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.7);*ip=i;*tp=t;return ret;}      static int vprofilebolla(const int i,const double t,Event *_ev){tracing("vprofilebolla","rising.c",172); {
  char name[80];

 sprintf (name, "8secbol-%g", t);
  FILE*fp = fopen (name, "w");
    for (double y = 0; y <= 0.5; y += 0.02)
    {
        for (double x = 0; x <= 2; x += 0.02)
  ...
  fclose (fp);
}{end_tracing("vprofilebolla","rising.c",186);return 0;}end_tracing("vprofilebolla","rising.c",186);}
#line 204 "rising.c"
...
}{end_tracing("snapshot","rising.c",213);return 0;}end_tracing("snapshot","rising.c",213);}
...
static void _init_solver (void)
{
  ...
  event_register((Event){0,1,init_0,{init_0_expr0},((int *)0),((double *)0),"rising.c",81,"init"});
  event_register((Event){0,1,output_field_bolla,{output_field_bolla_expr0},((int *)0),((double *)0),"rising.c",122,"output_field_bolla"});
  event_register((Event){0,1,vprofile,{vprofile_expr0},((int *)0),((double *)0),"rising.c",156,"vprofile"});
  event_register((Event){0,1,vprofilebolla,{vprofilebolla_expr0},((int *)0),((double *)0),"rising.c",172,"vprofilebolla"});
  event_register((Event){0,2,snapshot,{snapshot_expr0,snapshot_expr1},((int *)0),((double *)0),"rising.c",204,"snapshot"});
  ...
  event_register((Event){0,1,acceleration_2,{acceleration_2_expr0},((int *)0),((double *)0),"rising.c",97,"acceleration"});
