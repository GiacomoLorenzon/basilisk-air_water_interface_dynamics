...
{_init_solver();
  ...
  init_grid(1 << 9);
    ...
    printf("axis %d reduced %d level %d mac %d adapt %d",AXIS, REDUCED, 9, MAC, ADAPT);
...
static int init_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0);*ip=i;*tp=t;return ret;}      static int init_0(const int i,const double t,Event *_ev){tracing("init_0","rising.c",90);
{
...
}{end_tracing("init_0","rising.c",101);return 0;}end_tracing("init_0","rising.c",101);}




static int acceleration_2_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++);*ip=i;*tp=t;return ret;}      static int acceleration_2(const int i,const double t,Event *_ev){tracing("acceleration_2","rising.c",106);
{
  vector av = a;
  foreach_face_stencil()_stencil_is_face_x(){
...
}{end_tracing("acceleration_2","rising.c",111);return 0;}end_tracing("acceleration_2","rising.c",111);}
# 160 "rising.c"
static int logfile_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++);*ip=i;*tp=t;return ret;}      static int logfile(const int i,const double t,Event *_ev){tracing("logfile","rising.c",160);
{
...
}{end_tracing("output_field_bolla","rising.c",236);return 0;}end_tracing("output_field_bolla","rising.c",236);}

static int output_field_fuori_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= 6.0001);*ip=i;*tp=t;return ret;}static int output_field_fuori_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t += 0.1);*ip=i;*tp=t;return ret;}static int output_field_fuori_expr2(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0.0);*ip=i;*tp=t;return ret;}      static int output_field_fuori(const int i,const double t,Event *_ev){tracing("output_field_fuori","rising.c",238);
{
...
static int interface_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= 6.0001);*ip=i;*tp=t;return ret;}static int interface_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t += 0.1);*ip=i;*tp=t;return ret;}static int interface_expr2(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0.0);*ip=i;*tp=t;return ret;}      static int interface(const int i,const double t,Event *_ev){tracing("interface","rising.c",292);
{
  ...
  fprintf(fp5, "\n=====================\n");
  fclose(fp5);
}{end_tracing("interface","rising.c",307);return 0;}end_tracing("interface","rising.c",307);}
# 324 "rising.c"
...
}{end_tracing("snapshot","rising.c",333);return 0;}end_tracing("snapshot","rising.c",333);}
# 403 "rising.c"
static int velocity_grid_x_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int velocity_grid_x(const int i,const double t,Event *_ev){tracing("velocity_grid_x","rising.c",403); {
  char name[80];
  ...
  fclose (fp);
}{end_tracing("velocity_grid_x","rising.c",418);return 0;}end_tracing("velocity_grid_x","rising.c",418);}
static int velocity_grid_y_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int velocity_grid_y(const int i,const double t,Event *_ev){tracing("velocity_grid_y","rising.c",419); {
  char name[80];
  ...
  fclose (fp);
}{end_tracing("velocity_grid_y","rising.c",434);return 0;}end_tracing("velocity_grid_y","rising.c",434);}
static int pressure_grid_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int pressure_grid(const int i,const double t,Event *_ev){tracing("pressure_grid","rising.c",435); {
  char name[80];
  ...
  fclose (fp);
}{end_tracing("pressure_grid","rising.c",450);return 0;}end_tracing("pressure_grid","rising.c",450);}
static int vorticity_grid_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int vorticity_grid(const int i,const double t,Event *_ev){tracing("vorticity_grid","rising.c",451); {
  char name[80];
...
}{end_tracing("vorticity_grid","rising.c",469);return 0;}end_tracing("vorticity_grid","rising.c",469);}
# 2 "ast/init_solver.h"
...
static void _init_solver (void)
{
  ...
  event_register((Event){0,1,init_0,{init_0_expr0},((int *)0),((double *)0),"rising.c",90,"init"});
  event_register((Event){0,1,logfile,{logfile_expr0},((int *)0),((double *)0),"rising.c",160,"logfile"});
  event_register((Event){0,3,output_field_bolla,{output_field_bolla_expr0,output_field_bolla_expr1,output_field_bolla_expr2},((int *)0),((double *)0),"rising.c",204,"output_field_bolla"});
  event_register((Event){0,3,output_field_fuori,{output_field_fuori_expr0,output_field_fuori_expr1,output_field_fuori_expr2},((int *)0),((double *)0),"rising.c",238,"output_field_fuori"});
  event_register((Event){0,3,interface,{interface_expr0,interface_expr1,interface_expr2},((int *)0),((double *)0),"rising.c",292,"interface"});
  event_register((Event){0,2,snapshot,{snapshot_expr0,snapshot_expr1},((int *)0),((double *)0),"rising.c",324,"snapshot"});
  event_register((Event){0,1,velocity_grid_x,{velocity_grid_x_expr0},((int *)0),((double *)0),"rising.c",403,"velocity_grid_x"});
  event_register((Event){0,1,velocity_grid_y,{velocity_grid_y_expr0},((int *)0),((double *)0),"rising.c",419,"velocity_grid_y"});
  event_register((Event){0,1,pressure_grid,{pressure_grid_expr0},((int *)0),((double *)0),"rising.c",435,"pressure_grid"});
  event_register((Event){0,1,vorticity_grid,{vorticity_grid_expr0},((int *)0),((double *)0),"rising.c",451,"vorticity_grid"});
  ...
  event_register((Event){0,1,acceleration_2,{acceleration_2_expr0},((int *)0),((double *)0),"rising.c",106,"acceleration"});
