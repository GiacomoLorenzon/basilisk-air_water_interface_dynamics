...
# 1 "/root/mnt/basilisk/src/grid/boundaries.h" 1
...
# 964 "/root/mnt/basilisk/src/common.h" 2
...
# 1 "/root/mnt/basilisk/src/grid/stencils.h" 1
...
# 1445 "/root/mnt/basilisk/src/common.h" 2
# 14 "rising-cpp.c" 2
# 1 "grid/quadtree.h" 1
...
# 2 "/root/mnt/basilisk/src/grid/tree.h" 2
...
# 7 "/root/mnt/basilisk/src/grid/tree.h" 2
...
# 120 "/root/mnt/basilisk/src/grid/foreach_cell.h"
      }
    }
  }
@
...
@def foreach_cell_post_root(condition, root)
 ...
 break;
# 241 "/root/mnt/basilisk/src/grid/foreach_cell.h"
      default: {
        POINT_VARIABLES;
...
# 344 "/root/mnt/basilisk/src/grid/tree.h" 2
...
# 524 "/root/mnt/basilisk/src/grid/tree.h" 2
...
# 2 "/root/mnt/basilisk/src/grid/cartesian-common.h" 2
...
# 47 "/root/mnt/basilisk/src/grid/cartesian-common.h" 2
...
# 4 "/root/mnt/basilisk/src/grid/multigrid-common.h" 2
...
# 5 "/root/mnt/basilisk/src/grid/tree-common.h" 2
...
# 1672 "/root/mnt/basilisk/src/grid/tree.h" 2
...
@if _MPI
# 1 "grid/tree-mpi.h" 1
# 1 "/root/mnt/basilisk/src/grid/tree-mpi.h"
...
# 234 "/root/mnt/basilisk/src/grid/tree-mpi.h"
static void mpi_recv_check (void * buf, int count, MPI_Datatype datatype,
       int source, int tag,
       MPI_Comm comm, MPI_Status * status,
       const char * name)
{
# 269 "/root/mnt/basilisk/src/grid/tree-mpi.h"
...
#line 397
{
 ...
 {scalar*_i=(scalar*)( listv);if(_i)for(scalar s=*_i;(&s)->i>=0;s=*++_i){ {
   for (int i = 0; i <= 1; i++)
     for (int j = 0; j <= 1; j++)
# 418 "/root/mnt/basilisk/src/grid/tree-mpi.h"
       {
  if (allocated(i,j,0))
...
{tracing("mpi_boundary_update_buffers","/root/mnt/basilisk/src/grid/tree-mpi.h",858);
 ...
 continue;
  ...
  prof_stop();
# 1015 "/root/mnt/basilisk/src/grid/tree-mpi.h"
...
{
# 1121 "/root/mnt/basilisk/src/grid/tree-mpi.h"
}
...
# 1435 "/root/mnt/basilisk/src/grid/tree-mpi.h"
...
# 1687 "/root/mnt/basilisk/src/grid/tree.h" 2
# 1 "grid/balance.h" 1
# 1 "/root/mnt/basilisk/src/grid/balance.h"
...
{tracing("balance","/root/mnt/basilisk/src/grid/balance.h",201);
 ...
 nl++;
  ...
  FILE * fp = NULL;
# 261 "/root/mnt/basilisk/src/grid/balance.h"
...
# 305 "/root/mnt/basilisk/src/grid/balance.h"
...
# 1688 "/root/mnt/basilisk/src/grid/tree.h" 2
@else
void mpi_boundary_refine (scalar * list){}
...
@endif
# 4 "/root/mnt/basilisk/src/grid/quadtree.h" 2
...
# 431 "/root/mnt/basilisk/src/utils.h" 2
# 12 "/root/mnt/basilisk/src/run.h" 2
...
# 28 "/root/mnt/basilisk/src/navier-stokes/centered.h" 2
# 1 "./timestep.h" 1
...
# 29 "/root/mnt/basilisk/src/navier-stokes/centered.h" 2
# 1 "./bcg.h" 1
...
# 30 "/root/mnt/basilisk/src/navier-stokes/centered.h" 2
...
# 2 "/root/mnt/basilisk/src/viscosity.h" 2
...
# 34 "/root/mnt/basilisk/src/navier-stokes/centered.h" 2
...
# 13 "/root/mnt/basilisk/src/fractions.h" 2
...
# 20 "/root/mnt/basilisk/src/fractions.h" 2
...
# 36 "/root/mnt/basilisk/src/vof.h" 2
...
# 14 "/root/mnt/basilisk/src/two-phase.h" 2
...
# 16 "/root/mnt/basilisk/src/tension.h" 2
# 1 "curvature.h" 1
...
# 67 "/root/mnt/basilisk/src/curvature.h" 2
...
# 1 "utils.h" 1
# 2 "/root/mnt/basilisk/src/parabola.h" 2
...
# 331 "/root/mnt/basilisk/src/curvature.h" 2
...
# 17 "/root/mnt/basilisk/src/tension.h" 2
...
static int init_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0);*ip=i;*tp=t;return ret;}      static int init_0(const int i,const double t,Event *_ev){tracing("init_0","rising.c",109);
{
...
}{end_tracing("init_0","rising.c",120);return 0;}end_tracing("init_0","rising.c",120);}




static int acceleration_2_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++);*ip=i;*tp=t;return ret;}      static int acceleration_2(const int i,const double t,Event *_ev){tracing("acceleration_2","rising.c",125);
{
  vector av = a;
  foreach_face_stencil()_stencil_is_face_x(){
...
}{end_tracing("acceleration_2","rising.c",130);return 0;}end_tracing("acceleration_2","rising.c",130);}
# 179 "rising.c"
static int logfile_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++);*ip=i;*tp=t;return ret;}      static int logfile(const int i,const double t,Event *_ev){tracing("logfile","rising.c",179);
{
...
}{end_tracing("logfile","rising.c",219);return 0;}end_tracing("logfile","rising.c",219);}



static int output_field_bolla_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= 0.001);*ip=i;*tp=t;return ret;}static int output_field_bolla_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t += 0.1);*ip=i;*tp=t;return ret;}static int output_field_bolla_expr2(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0.0);*ip=i;*tp=t;return ret;}      static int output_field_bolla(const int i,const double t,Event *_ev){tracing("output_field_bolla","rising.c",223);
{
...
}{end_tracing("output_field_bolla","rising.c",255);return 0;}end_tracing("output_field_bolla","rising.c",255);}

static int output_field_fuori_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= 0.001);*ip=i;*tp=t;return ret;}static int output_field_fuori_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t += 0.1);*ip=i;*tp=t;return ret;}static int output_field_fuori_expr2(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0.0);*ip=i;*tp=t;return ret;}      static int output_field_fuori(const int i,const double t,Event *_ev){tracing("output_field_fuori","rising.c",257);
{
...
}{end_tracing("output_field_fuori","rising.c",289);return 0;}end_tracing("output_field_fuori","rising.c",289);}
# 311 "rising.c"
static int interface_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= 0.001);*ip=i;*tp=t;return ret;}static int interface_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t += 0.1);*ip=i;*tp=t;return ret;}static int interface_expr2(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0.0);*ip=i;*tp=t;return ret;}      static int interface(const int i,const double t,Event *_ev){tracing("interface","rising.c",311);
{
  ...
  fprintf(fp5, "\n=====================\n");
  fclose(fp5);
}{end_tracing("interface","rising.c",326);return 0;}end_tracing("interface","rising.c",326);}
# 343 "rising.c"
...
}{end_tracing("snapshot","rising.c",352);return 0;}end_tracing("snapshot","rising.c",352);}
# 422 "rising.c"
static int velocity_grid_x_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int velocity_grid_x(const int i,const double t,Event *_ev){tracing("velocity_grid_x","rising.c",422); {
  char name[80];
  ...
  fclose (fp);
}{end_tracing("velocity_grid_x","rising.c",437);return 0;}end_tracing("velocity_grid_x","rising.c",437);}
static int velocity_grid_y_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int velocity_grid_y(const int i,const double t,Event *_ev){tracing("velocity_grid_y","rising.c",438); {
  char name[80];
  ...
  fclose (fp);
}{end_tracing("velocity_grid_y","rising.c",453);return 0;}end_tracing("velocity_grid_y","rising.c",453);}
static int pressure_grid_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int pressure_grid(const int i,const double t,Event *_ev){tracing("pressure_grid","rising.c",454); {
  char name[80];
  ...
  fclose (fp);
}{end_tracing("pressure_grid","rising.c",469);return 0;}end_tracing("pressure_grid","rising.c",469);}
static int vorticity_grid_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int vorticity_grid(const int i,const double t,Event *_ev){tracing("vorticity_grid","rising.c",470); {
  char name[80];
...
}{end_tracing("vorticity_grid","rising.c",488);return 0;}end_tracing("vorticity_grid","rising.c",488);}
# 2 "ast/init_solver.h"
...
static void _init_solver (void)
{
  ...
  event_register((Event){0,1,init_0,{init_0_expr0},((int *)0),((double *)0),"rising.c",109,"init"});
  event_register((Event){0,1,logfile,{logfile_expr0},((int *)0),((double *)0),"rising.c",179,"logfile"});
  event_register((Event){0,3,output_field_bolla,{output_field_bolla_expr0,output_field_bolla_expr1,output_field_bolla_expr2},((int *)0),((double *)0),"rising.c",223,"output_field_bolla"});
  event_register((Event){0,3,output_field_fuori,{output_field_fuori_expr0,output_field_fuori_expr1,output_field_fuori_expr2},((int *)0),((double *)0),"rising.c",257,"output_field_fuori"});
  event_register((Event){0,3,interface,{interface_expr0,interface_expr1,interface_expr2},((int *)0),((double *)0),"rising.c",311,"interface"});
  event_register((Event){0,2,snapshot,{snapshot_expr0,snapshot_expr1},((int *)0),((double *)0),"rising.c",343,"snapshot"});
  event_register((Event){0,1,velocity_grid_x,{velocity_grid_x_expr0},((int *)0),((double *)0),"rising.c",422,"velocity_grid_x"});
  event_register((Event){0,1,velocity_grid_y,{velocity_grid_y_expr0},((int *)0),((double *)0),"rising.c",438,"velocity_grid_y"});
  event_register((Event){0,1,pressure_grid,{pressure_grid_expr0},((int *)0),((double *)0),"rising.c",454,"pressure_grid"});
  event_register((Event){0,1,vorticity_grid,{vorticity_grid_expr0},((int *)0),((double *)0),"rising.c",470,"vorticity_grid"});
  ...
  event_register((Event){0,1,acceleration_2,{acceleration_2_expr0},((int *)0),((double *)0),"rising.c",125,"acceleration"});
