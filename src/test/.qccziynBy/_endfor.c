...
static int init_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0);*ip=i;*tp=t;return ret;}      static int init_0(const int i,const double t,Event *_ev){tracing("init_0","rising.c",88);
{
...
}{end_tracing("init_0","rising.c",99);return 0;}end_tracing("init_0","rising.c",99);}




static int acceleration_2_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++);*ip=i;*tp=t;return ret;}      static int acceleration_2(const int i,const double t,Event *_ev){tracing("acceleration_2","rising.c",104);
{
  vector av = a;
  foreach_face_stencil()_stencil_is_face_x(){
...
}{end_tracing("acceleration_2","rising.c",109);return 0;}end_tracing("acceleration_2","rising.c",109);}
# 158 "rising.c"
static int logfile_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++);*ip=i;*tp=t;return ret;}      static int logfile(const int i,const double t,Event *_ev){tracing("logfile","rising.c",158);
{
...
}{end_tracing("output_field_bolla","rising.c",234);return 0;}end_tracing("output_field_bolla","rising.c",234);}

static int output_field_fuori_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= 6.0001);*ip=i;*tp=t;return ret;}static int output_field_fuori_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t += 0.1);*ip=i;*tp=t;return ret;}static int output_field_fuori_expr2(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0.0);*ip=i;*tp=t;return ret;}      static int output_field_fuori(const int i,const double t,Event *_ev){tracing("output_field_fuori","rising.c",236);
{
...
static int interface_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= 6.0001);*ip=i;*tp=t;return ret;}static int interface_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t += 0.1);*ip=i;*tp=t;return ret;}static int interface_expr2(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0.0);*ip=i;*tp=t;return ret;}      static int interface(const int i,const double t,Event *_ev){tracing("interface","rising.c",290);
{
  ...
  fprintf(fp5, "\n=====================\n");
  fclose(fp5);
}{end_tracing("interface","rising.c",305);return 0;}end_tracing("interface","rising.c",305);}
# 322 "rising.c"
...
}{end_tracing("snapshot","rising.c",331);return 0;}end_tracing("snapshot","rising.c",331);}
# 401 "rising.c"
static int velocity_grid_x_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int velocity_grid_x(const int i,const double t,Event *_ev){tracing("velocity_grid_x","rising.c",401); {
  char name[80];
  ...
  fclose (fp);
}{end_tracing("velocity_grid_x","rising.c",416);return 0;}end_tracing("velocity_grid_x","rising.c",416);}
static int velocity_grid_y_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int velocity_grid_y(const int i,const double t,Event *_ev){tracing("velocity_grid_y","rising.c",417); {
  char name[80];
  ...
  fclose (fp);
}{end_tracing("velocity_grid_y","rising.c",432);return 0;}end_tracing("velocity_grid_y","rising.c",432);}
static int pressure_grid_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int pressure_grid(const int i,const double t,Event *_ev){tracing("pressure_grid","rising.c",433); {
  char name[80];
  ...
  fclose (fp);
}{end_tracing("pressure_grid","rising.c",448);return 0;}end_tracing("pressure_grid","rising.c",448);}
static int vorticity_grid_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1);*ip=i;*tp=t;return ret;}      static int vorticity_grid(const int i,const double t,Event *_ev){tracing("vorticity_grid","rising.c",449); {
  char name[80];
...
}{end_tracing("vorticity_grid","rising.c",467);return 0;}end_tracing("vorticity_grid","rising.c",467);}
# 2 "ast/init_solver.h"
