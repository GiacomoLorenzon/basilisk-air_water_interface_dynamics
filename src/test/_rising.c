...
#line 1339 "/root/mnt/basilisk/src/output.h"
  ...
  restore_mpi (fp, list);
#line 1369 "/root/mnt/basilisk/src/output.h"
  scalar * other = NULL;
  {scalar*_i=(scalar*)( all);if(_i)for(scalar s=*_i;(&s)->i>=0;s=*++_i){
...
{_init_solver();
  ...
  rho2 = 100., mu2 = 1., _attribute[f.i].sigma = 24.5;
...
static int init_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0);*ip=i;*tp=t;return ret;}      static int init_0(const int i,const double t,Event *_ev){tracing("init_0","rising.c",77);
{
...
}{end_tracing("init_0","rising.c",86);return 0;}end_tracing("init_0","rising.c",86);}





static int acceleration_2_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++);*ip=i;*tp=t;return ret;}      static int acceleration_2(const int i,const double t,Event *_ev){tracing("acceleration_2","rising.c",92);
{
  vector av = a;
  foreach_face_stencil()_stencil_is_face_x(){
...
}{end_tracing("acceleration_2","rising.c",97);return 0;}end_tracing("acceleration_2","rising.c",97);}
...
static int logfile_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++);*ip=i;*tp=t;return ret;}      static int logfile(const int i,const double t,Event *_ev){tracing("logfile","rising.c",115);
{

  char nameF[80] = "rising_output_SIMNAME/log_file.txt";
  static FILE * fp1;
...
}{end_tracing("logfile","rising.c",155);return 0;}end_tracing("logfile","rising.c",155);}



static int output_field_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= 3.0001);*ip=i;*tp=t;return ret;}static int output_field_0_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t += 0.1);*ip=i;*tp=t;return ret;}static int output_field_0_expr2(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0.0);*ip=i;*tp=t;return ret;}      static int output_field_0(const int i,const double t,Event *_ev){tracing("output_field_0","rising.c",159);
{

    char nameF[80];
    sprintf (nameF, "rising_output_SIMNAME/output_field-%2.1f.txt", t);
    ...
    static FILE * fp2;
     ...
     if (i == 0) {
       ...
       foreach_stencil()
       {
_stencil_val(u.x,0,0,0);_stencil_val(u.y,0,0,0); _stencil_val(p,0,0,0); _stencil_val(vort,0,0,0);  
...
foreach()
       {
         fprintf (fp2, "%f %f %f %f %f %f",x,y,val(u.x,0,0,0),val(u.y,0,0,0), val(p,0,0,0), val(vort,0,0,0));
       }end_foreach();}
       fprintf(fp2, "\n\n");
       fclose(fp2);
     } else {
...
}{end_tracing("output_field_0","rising.c",193);return 0;}end_tracing("output_field_0","rising.c",193);}
#line 214 "rising.c"
static int interface_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= 3.0001);*ip=i;*tp=t;return ret;}static int interface_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t += 0.1);*ip=i;*tp=t;return ret;}static int interface_expr2(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0.0);*ip=i;*tp=t;return ret;}      static int interface(const int i,const double t,Event *_ev){tracing("interface","rising.c",214);
{
    char nameF[80] = "rising_output_SIMNAME/interface.txt";
    static FILE * fp5;
  ...
  fprintf(fp5, "\n=====================\n");
  fclose(fp5);
}{end_tracing("interface","rising.c",229);return 0;}end_tracing("interface","rising.c",229);}
#line 246 "rising.c"
...
}{end_tracing("snapshot","rising.c",255);return 0;}end_tracing("snapshot","rising.c",255);}
...
static void _init_solver (void)
{
  ...
  event_register((Event){0,1,init_0,{init_0_expr0},((int *)0),((double *)0),"rising.c",77,"init"});
  event_register((Event){0,1,logfile,{logfile_expr0},((int *)0),((double *)0),"rising.c",115,"logfile"});
  event_register((Event){0,3,output_field_0,{output_field_0_expr0,output_field_0_expr1,output_field_0_expr2},((int *)0),((double *)0),"rising.c",159,"output_field"});
  event_register((Event){0,3,interface,{interface_expr0,interface_expr1,interface_expr2},((int *)0),((double *)0),"rising.c",214,"interface"});
  event_register((Event){0,2,snapshot,{snapshot_expr0,snapshot_expr1},((int *)0),((double *)0),"rising.c",246,"snapshot"});
  ...
  event_register((Event){0,1,acceleration_2,{acceleration_2_expr0},((int *)0),((double *)0),"rising.c",92,"acceleration"});
